...
def index(request):
    if request.user.is_teacher:
        return render(request, 'attend/t_homepage.html')
    if request.user.is_student:
        return render(request, 'attend/homepage.html')
    return render(request, 'attend/logout.html')
...
def attendance(request, stud_id):
    ...
    for ass in ass_list:
        try:
            ...
            a.save()
        att_list.append(a)
    return render(request, 'attend/attendance.html', {'att_list': att_list})
...
def attendance_detail(request, stud_id, course_id):
    ...
    return render(request, 'attend/att_detail.html', {'att_list': att_list, 'cr': cr})
...
def t_clas(request, teacher_id, choice):
    ...
    return render(request, 'attend/t_clas.html', {'teacher1': teacher1, 'choice': choice})
...
def t_student(request, assign_id):
    ...
    for stud in ass.class_id.student_set.all():
        try:
            ...
            a.save()
        att_list.append(a)
    return render(request, 'attend/t_students.html', {'att_list': att_list})
...
def t_class_date(request, assign_id):
    ...
    return render(request, 'attend/t_class_date.html', {'att_list': att_list})
...
def t_attendance(request, ass_c_id):
    ...
    return render(request, 'attend/t_attendance.html', context)
...
def edit_att(request, ass_c_id):
    ...
    return render(request, 'attend/t_edit_att.html', context)
...
def t_attendance_detail(request, stud_id, course_id):
    ...
    cr = get_object_or_404(Course, id=course_id)
    att_list = Attendance.objects.filter(course=cr, student=stud).order_by('date')
    return render(request, 'attend/t_att_detail.html', {'att_list': att_list, 'cr': cr})
...
def t_extra_class(request, assign_id):
    ...
    return render(request, 'attend/t_extra_class.html', context)
...
def t_report(request, assign_id):
    ...
    for stud in ass.class_id.student_set.all():
        ...
        sc_list.append(a)
    return render(request, 'attend/t_report.html', {'sc_list': sc_list})
...
def timetable(request, class_id):
    ...
    return render(request, 'attend/timetable.html', context)
...
def t_timetable(request, teacher_id):
    ...
    return render(request, 'attend/t_timetable.html', context)
...
def free_teachers(request, asst_id):
    ...
    return render(request, 'attend/free_teachers.html', {'ft_list': ft_list})
